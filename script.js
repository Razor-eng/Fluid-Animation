...
function startGUI () {
    ...
    let github = gui.add({ fun : () => {
        window.open('https://github.com/Razor-eng');
    ...
    let instagram = gui.add({ fun : () => {
        ...
        window.open('https://www.instagram.com/rajat_maharana/');
    } }, 'fun').name('Instagram');
    ...
    let app = gui.add({ fun : () => {
        ...
        window.open('https://rkm.000webhostapp.com/');
    } }, 'fun').name('Rajat Kumar Maharana');
